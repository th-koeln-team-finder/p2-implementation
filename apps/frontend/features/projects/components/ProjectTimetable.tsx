        ...
        {Object.values(Weekdays).map((weekday, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex w-3/12 items-center justify-center border-border border-r bg-muted p-4 font-medium text-muted-foreground">
                {header}
              </div>
              {/* Times (Content Column) */}
              <div className="flex w-9/12 items-center justify-center p-4 text-muted-foreground first:rounded-tr-md last:rounded-br-md">
