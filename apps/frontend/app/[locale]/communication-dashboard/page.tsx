...
import { getInvitationsForUser } from '@/features/invitation/invitations.queries'
...
export default async function CommunicationDashboard() {
  ...
  const invitations = await getInvitationsForUser(session.user.id)
